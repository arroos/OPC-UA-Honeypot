...
/* ======================================================================
 * Modified 2019 by Andrew Roos to provide public access to the 
 * TcpMessageSocket remote endpoint. 
 * ======================================================================*/
...
namespace Opc.Ua.Bindings
{
    ...
    public class TcpMessageSocket : IMessageSocket
    {
        ...
        public EndPoint getRemoteEndpoint() // HONEYPOT
        {
            return (m_socket == null ? null : m_socket.RemoteEndPoint);
        }
        #endregion
